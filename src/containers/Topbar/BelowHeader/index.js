...
const menu = (
  <Menu onClick={handleMenuClick}>
    ...
    <Menu.Item key="2">Claims</Menu.Item>
    <Menu.Item key="3">Policyholders</Menu.Item>
  </Menu>
);
      ...
      <ul className="gx-sub-popover">
        {languageData.map(language =>
          <li className="gx-media gx-pointer" key={JSON.stringify(language)} onClick={(e) =>
            ...
            <span className="gx-language-text">{language.name}test1</span>
          </li>
        )}
      </ul>
    </CustomScrollbars>);
        ...
        <div className="gx-container">
          <div className="gx-header-horizontal-main-flex">
            ...
            <div className="gx-header-search gx-d-none gx-d-lg-flex">
              ...
              <Select defaultValue="Policyholders" style={{width: 120}} onChange={handleChange}>
                <Option value="jack">Products</Option>
                <Option value="Policyholders">Claims</Option>
                <Option value="Yiminghe">Policyholders</Option>
              </Select>
            </div>
