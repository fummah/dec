...
const ClaimItem = ({data}) => {
  const {image, title, amount, date} = data;
    ...
    <div className="gx-media gx-featured-item">
      ...
      <div className="gx-media-body gx-featured-content">
        <div className="gx-featured-content-left">
          <Tag className="gx-rounded-xs gx-text-uppercase" color="#06BB8A">Open</Tag>
          <h3 className="gx-mb-2">{title}</h3>
          <div className="ant-row-flex">
            <div className="gx-media gx-text-grey gx-mb-1">
              <i className={`icon icon-card gx-fs-lg gx-mr-2 gx-d-inline-flex gx-vertical-align-middle`}/>
              <span className="gx-media-body gx-ml-1">{amount}</span>
            </div>
            
          </div>
            <div className="ant-row-flex">           
             <div className="gx-media gx-mb-1">
              <i className={`icon icon-calendar gx-fs-lg gx-mr-2 gx-d-inline-flex gx-vertical-align-middle`}/>
              <span className="gx-media-body gx-ml-1">2024-09-09 - 2025-09-09</span>
            </div>
          </div>
        </div>
        <div className="gx-featured-content-right gx-profile-content-right">
          ...
          <p className="gx-text-primary gx-text-truncate gx-mt-sm-auto gx-mb-0 gx-pointer" onClick={()=>redirectToItem(1,'claim')}>View Claim <i
