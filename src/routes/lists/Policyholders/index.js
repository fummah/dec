...
import policyholderList from "./data/policyholdersList";
import AppModuleHeader from "components/AppModuleHeader/index";
import IntlMessages from "util/IntlMessages";
import PolicyholdersList from "../../../components/lists/PolicyholdersList/index";
      ...
      <div className="gx-module-side-content">
        <CustomScrollbars className="gx-module-side-scroll">
          <div className="gx-module-add-task">           
              <AddPolicyholder title="Add new Policyholder" icon="add-circle"/>
          </div>
          ...
          <div className="gx-module-box">
            ...
            <div className="gx-module-box-content">
              ...
              <CustomScrollbars className="gx-module-content-scroll">
                <PolicyholdersList policyholdersList={policyholderList}/>
              </CustomScrollbars>
